...
$sql="replace into application(username,name,average) values('$username','$name','$average')";
...
<br/>
<p style="text-align:center;font-size:16px;">点击<a href="countrymoney.php" style="text-decoration:none;">此处</a>返回申请界面</p>
</div>
<div id="bottom_2">
