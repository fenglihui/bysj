...
$sql="insert into school(username,name,average) values('$username','$name','$average')";
...
<br/>
<p style="text-align:center;font-size:16px;">点击<a href="schoolmoney.php" style="text-decoration:none;">此处</a>返回申请界面</p>
</div>
<div id="bottom_2">
